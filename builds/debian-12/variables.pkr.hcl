...
variable "seed_vm_id"    { type = number; default = 8998 }
variable "template_id"   { type = number; default = 9001 }
variable "template_name" { type = string; default = "debian-12-cloud" }
...
variable "ssh_username"  { type = string; default = "admin" }
